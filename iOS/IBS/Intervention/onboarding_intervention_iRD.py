...
from iOS.IBS.functions_iRD import click_element, send_keys, swipe_down, swipe_up, go_next
...
class Onboarding:
    ...
    def test_onboarding(self):
        ...
        click_element(self.driver, index=0, path='select_IBS_program')
        ...
        click_element(self.driver, index=1, path='//XCUIElementTypeStaticText[@name="Ich bin nicht schwanger."]')
        click_element(self.driver, index=0, path="confirm")
