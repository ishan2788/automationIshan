...
class Onboarding:
    ...
    def test_setup(self):
        ...
        self.user_name = "ishan27588" + "+" + self.access_code + "abc" + "@gmail.com"
    ...
    def test_onboarding(self):
        ...
        click_element(self.driver, index=0, path="program selection screen program card CED")
        ...
        el[0].click()
        el[1].click()
        click_element(self.driver, index=0, path="disease subtype selection screen continue button")
