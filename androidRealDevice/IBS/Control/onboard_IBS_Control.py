...
from androidRealDevice.IBS.Control.functions_IBS_Control import click_element, send_keys, swipe_down, go_next, swipe_up
...
class Onboarding:
    ...
    def test_onboarding(self):
        ...
        WebDriverWait(self.driver, 60).until(pause.presence_of_element_located((AppiumBy.XPATH, path)))
        go_next(self.driver, case=1)
